      ...
      newAddressTab(new NewAddressTab(this))
{
    ...
    shortcutAdd = new QShortcut(QKeySequence(Qt::CTRL + Qt::Key_A), this);
    connect(shortcutAdd, &QShortcut::activated, this, &AddressWidget::AddThis);

    shortcutDel = new QShortcut(QKeySequence(Qt::CTRL + Qt::Key_D), this);
    connect(shortcutDel, &QShortcut::activated, this, &AddressWidget::DeleteThis);

    shortcutEdit = new QShortcut(QKeySequence(Qt::CTRL + Qt::Key_E), this);
    connect(shortcutEdit, &QShortcut::activated, this, &AddressWidget::EditThis);

    setupTabs(); 
}

void AddressWidget::AddThis()
{
    showAddEntryDialog();
}

void AddressWidget::DeleteThis()
{
    removeEntry();
}

void AddressWidget::EditThis()
{
    editEntry();
}
...
void AddressWidget::setupTabs()
{
    ...
    const auto groups = { "ABCDEFGHIJKLMNOPQRSTUVWXYZ"_L1, "ABC"_L1, "DEF"_L1, "GHI"_L1, "JKL"_L1, "MNO"_L1, "PQR"_L1,
